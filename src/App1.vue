    ...
    <div class="bg-gray-900">
      ...
      <main class="isolate">
          ...
          <div class="py-24 sm:py-32 lg:pb-40">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
              <div class="mx-auto max-w-2xl text-center">
                <h1 class="text-balance text-5xl font-semibold tracking-tight text-white sm:text-7xl">Deploy to the cloud with confidence</h1>
        ...
        <div class="relative -z-10 mt-32 px-6 lg:px-8">
          ...
          <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-balance text-4xl font-semibold tracking-tight text-white sm:text-5xl">Boost your productivity. Start using our app today.</h2>
