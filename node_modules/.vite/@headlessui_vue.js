  ...
  constructor(opts) {
    ...
    this.getTotalSize = () => {
      ...
      if (measurements.length === 0) {
        ...
        end = this.options.lanes === 1 ? (_a2 = (_a = measurements[measurements.length - 1]) == null ? void 0 : _a.end) != null ? _a2 : 0 : Math.max(...measurements.slice(-this.options.lanes).map((m4) => m4.end));
      }
...
function useVirtualizerBase(options) {
  ...
  watch(() => unref(options), (options2) => {
    virtualizer.setOptions(__spreadProps(__spreadValues({}, options2), {
...
function useVirtualizer(options) {
  return useVirtualizerBase(computed(() => __spreadValues({
    observeElementRect,
...
function w3(f5, m4, l4 = computed(() => true)) {
  function a5(e3, r4) {
    if (!l4.value || e3.defaultPrevented)
      return;
    let t8 = r4(e3);
    ...
    for (let o7 of c5) {
      ...
      if (n6 != null && n6.contains(t8) || e3.composed && e3.composedPath().includes(n6))
        return;
    }
...
function A(_a) {
  var _b = _a, { visible: r4 = true, features: t8 = 0, ourProps: e3, theirProps: o7 } = _b, i9 = __objRest(_b, ["visible", "features", "ourProps", "theirProps"]);
  var a5;
  let n6 = j(o7, e3), l4 = Object.assign(i9, { props: n6 });
  if (r4 || t8 & 2 && n6.static)
    return y2(l4);
  if (t8 & 1) {
    ...
    return u(d9, { [0]() {
      ...
      return y2(__spreadProps(__spreadValues({}, i9), { props: __spreadProps(__spreadValues({}, n6), { hidden: true, style: { display: "none" } }) }));
    } });
  }
  return y2(l4);
}
function y2({ props: r4, attrs: t8, slots: e3, slot: o7, name: i9 }) {
  var m4, h3;
  let _a = T2(r4, ["unmount", "static"]), { as: n6 } = _a, l4 = __objRest(_a, ["as"]), a5 = (m4 = e3.default) == null ? void 0 : m4.call(e3, o7), d9 = {};
  if (o7) {
    let u9 = false, c5 = [];
    for (let [p3, f5] of Object.entries(o7))
  ...
  if (n6 === "template") {
    if (a5 = b(a5 != null ? a5 : []), Object.keys(l4).length > 0 || Object.keys(t8).length > 0) {
      ...
      if (!v2(u9) || c5.length > 0)
        throw new Error(['Passing props on "template"!', "", `The current component <${i9} /> is rendering a "template".`, "However we need to passthrough the following props:", Object.keys(l4).concat(Object.keys(t8)).map((s7) => s7.trim()).filter((s7, g5, R3) => R3.indexOf(s7) === g5).sort((s7, g5) => s7.localeCompare(g5)).map((s7) => `  - ${s7}`).join(`
...
`));
      ...
      for (let s7 in p3)
        s7.startsWith("on") && (f5.props || (f5.props = {}), f5.props[s7] = p3[s7]);
      return f5;
    }
...
function j(...r4) {
  ...
  for (let i9 of r4)
    for (let n6 in i9)
      n6.startsWith("on") && typeof i9[n6] == "function" ? ((o7 = e3[n6]) != null || (e3[n6] = []), e3[n6].push(i9[n6])) : t8[n6] = i9[n6];
  if (t8.disabled || t8["aria-disabled"])
    return Object.assign(t8, Object.fromEntries(Object.keys(e3).map((i9) => [i9, void 0])));
  for (let i9 in e3)
    Object.assign(t8, { [i9](n6, ...l4) {
      let a5 = e3[i9];
      for (let d9 of a5) {
...
var f = defineComponent({ name: "Hidden", props: { as: { type: [Object, String], default: "div" }, features: { type: Number, default: 1 } }, setup(t8, { slots: n6, attrs: i9 }) {
  return () => {
    var r4;
    let _a = t8, { features: e3 } = _a, d9 = __objRest(_a, ["features"]), o7 = { "aria-hidden": (e3 & 2) === 2 ? true : (r4 = d9["aria-hidden"]) != null ? r4 : void 0, hidden: (e3 & 4) === 4 ? true : void 0, style: __spreadValues({ position: "fixed", top: 1, left: 1, width: 1, height: 0, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0" }, (e3 & 4) === 4 && (e3 & 2) !== 2 && { display: "none" }) };
  ...
  switch (l4.focus) {
    case 0: {
      for (let e3 = 0; e3 < t8.length; ++e3)
        if (!n6.resolveDisabled(t8[e3], e3, t8))
          return e3;
      return r4;
    }
    case 1: {
    ...
    case 4: {
      for (let e3 = 0; e3 < t8.length; ++e3)
        if (n6.resolveId(t8[e3], e3, t8) === l4.id)
          return e3;
      return r4;
    }
    case 5:
...
function e(i9 = {}, s7 = null, t8 = []) {
  for (let [r4, n6] of Object.entries(i9))
    o5(t8, f3(s7, r4), n6);
  return t8;
}
function f3(i9, s7) {
...
function o5(i9, s7, t8) {
  if (Array.isArray(t8))
    for (let [r4, n6] of t8.entries())
      o5(i9, f3(s7, r4.toString()), n6);
  else
    t8 instanceof Date ? i9.push([s7, t8.toISOString()]) : typeof t8 == "boolean" ? i9.push([s7, t8 ? "1" : "0"]) : typeof t8 == "string" ? i9.push([s7, t8]) : typeof t8 == "number" ? i9.push([s7, `${t8}`]) : t8 == null ? i9.push([s7, ""]) : e(t8, s7, i9);
}
function p(i9) {
  var t8, r4;
  ...
  if (s7) {
    for (let n6 of s7.elements)
      if (n6 !== i9 && (n6.tagName === "INPUT" && n6.type === "submit" || n6.tagName === "BUTTON" && n6.type === "submit" || n6.nodeName === "INPUT" && n6.type === "image")) {
        n6.click();
        return;
      }
...
var Ae = defineComponent({ name: "VirtualProvider", setup(a5, { slots: h3 }) {
  ...
  return watch([u9], () => {
    ...
    if (c5) {
      if (typeof process != "undefined" && process.env.JEST_WORKER_ID !== void 0 || r4.activationTrigger.value === 0)
        return;
...
var lt = defineComponent({ name: "Combobox", emits: { "update:modelValue": (a5) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], nullable: true, default: null }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, nullable: { type: Boolean, default: false }, multiple: { type: [Boolean], default: false }, immediate: { type: [Boolean], default: false }, virtual: { type: Object, default: null } }, inheritAttrs: false, setup(a5, { slots: h3, attrs: r4, emit: y4 }) {
  ...
  let l4 = { comboboxState: o7, value: R3, mode: M2, compare(t8, n6) {
    ...
    E6.value = false, V2 !== null && cancelAnimationFrame(V2), V2 = requestAnimationFrame(() => {
      if (a5.disabled || f5.value && !S3.value.static && o7.value === 1)
        return;
      if (l4.virtual.value) {
    ...
    if (l4.activeOptionIndex.value !== null) {
      if (l4.virtual.value)
        I2(l4.virtual.value.options[l4.activeOptionIndex.value]);
      else {
  ...
  return onMounted(() => {
    ...
    var C3, A6, j2;
    let _a = a5, { name: t8, disabled: n6, form: s7 } = _a, b2 = __objRest(_a, ["name", "disabled", "form"]), O4 = { open: o7.value === 0, disabled: n6, activeIndex: l4.activeOptionIndex.value, activeOption: l4.activeOptionIndex.value === null ? null : l4.virtual.value ? l4.virtual.value.options[(C3 = l4.activeOptionIndex.value) != null ? C3 : 0] : (j2 = (A6 = l4.options.value[l4.activeOptionIndex.value]) == null ? void 0 : A6.dataRef.value) != null ? j2 : null, value: R3.value };
    return h(Fragment, [...t8 != null && R3.value != null ? e({ [t8]: R3.value }).map(([q2, ue4]) => h(f, E2({ features: u4.Hidden, key: q2, as: "input", type: "hidden", hidden: true, readOnly: true, form: s7, disabled: n6, name: q2, value: ue4 }))) : [], A({ theirProps: __spreadValues(__spreadValues({}, r4), T2(b2, ["by", "defaultValue", "immediate", "modelValue", "multiple", "nullable", "onUpdate:modelValue", "virtual"])), ourProps: {}, slot: O4, slots: h3, attrs: r4, name: "Combobox" })]);
  };
} });
var at = defineComponent({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(a5, { attrs: h3, slots: r4 }) {
  ...
  return () => {
    let c5 = { open: o7.comboboxState.value === 0, disabled: o7.disabled.value }, f5 = __objRest(a5, []), S3 = { id: y4, ref: o7.labelRef, onClick: u9 };
...
var nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a5, { attrs: h3, slots: r4, expose: y4 }) {
  ...
  return () => {
    var E6, w6;
    let v4 = { open: u9.comboboxState.value === 0, disabled: u9.disabled.value, value: u9.value.value }, d9 = __objRest(a5, []), D = { ref: u9.buttonRef, id: o7, type: f5.value, tabindex: "-1", "aria-haspopup": "listbox", "aria-controls": (E6 = o3(u9.optionsRef)) == null ? void 0 : E6.id, "aria-expanded": u9.comboboxState.value === 0, "aria-labelledby": u9.labelRef.value ? [(w6 = o3(u9.labelRef)) == null ? void 0 : w6.id, o7].join(" ") : void 0, disabled: u9.disabled.value === true ? true : void 0, onKeydown: c5, onClick: e3 };
...
var it = defineComponent({ name: "ComboboxInput", props: { as: { type: [Object, String], default: "input" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, displayValue: { type: Function }, defaultValue: { type: String, default: void 0 }, id: { type: String, default: null } }, emits: { change: (a5) => true }, setup(a5, { emit: h3, attrs: r4, slots: y4, expose: o7 }) {
  ...
  onMounted(() => {
    watch([v4, e3.comboboxState, c5], ([i9, I2], [T5, l4]) => {
      ...
      g5 && ((l4 === 0 && I2 === 1 || i9 !== T5) && (g5.value = i9), requestAnimationFrame(() => {
        var s7;
        if (f5.value || !g5 || ((s7 = c5.value) == null ? void 0 : s7.activeElement) !== g5)
          return;
  ...
  function B2(i9) {
    ...
    if (f5.value = false, !((l4 = o3(e3.optionsRef)) != null && l4.contains(I2)) && !((g5 = o3(e3.buttonRef)) != null && g5.contains(I2)) && e3.comboboxState.value === 0)
...
var ut = defineComponent({ name: "ComboboxOptions", props: { as: { type: [Object, String], default: "ul" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, hold: { type: [Boolean], default: false } }, setup(a5, { attrs: h3, slots: r4, expose: y4 }) {
  ...
  return () => {
    ...
    return A({ ourProps: v4, theirProps: d9, slot: S3, attrs: h3, slots: o7.virtual.value && o7.comboboxState.value === 0 ? __spreadProps(__spreadValues({}, r4), { default: () => [h(Ae, {}, r4.default)] }) : r4, features: N2.RenderStrategy | N2.Static, visible: c5.value, name: "ComboboxOptions" });
  };
} });
var rt = defineComponent({ name: "ComboboxOption", props: { as: { type: [Object, String], default: "li" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false }, order: { type: [Number], default: null } }, setup(a5, { slots: h3, attrs: r4, expose: y4 }) {
  ...
  function E6() {
    var R3;
    if (a5.disabled || (R3 = o7.virtual.value) != null && R3.disabled(a5.value))
      return o7.goToOption(c3.Nothing);
  ...
  function $5(p3) {
    var V2;
    if (!w6.wasMoved(p3) || a5.disabled || (V2 = o7.virtual.value) != null && V2.disabled(a5.value) || f5.value)
      return;
...
var ue = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(t8, { attrs: n6, slots: r4, expose: l4 }) {
  ...
  return () => {
    let u9 = {}, T5 = { ref: o7, onKeydown: F3, onFocusout: H5 }, _a = t8, { features: d9, initialFocus: w6, containers: Q3 } = _a, O4 = __objRest(_a, ["features", "initialFocus", "containers"]);
    return h(Fragment, [Boolean(d9 & 4) && h(f, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: a5, features: u4.Focusable }), A({ ourProps: T5, theirProps: __spreadValues(__spreadValues({}, n6), O4), slot: u9, attrs: n6, slots: r4, name: "FocusTrap" }), Boolean(d9 & 4) && h(f, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: a5, features: u4.Focusable })]);
  };
} }), { features: A2 });
function W(t8) {
  let n6 = ref(t6.slice());
...
function z({ ownerDocument: t8, container: n6, initialFocus: r4 }, l4) {
  ...
  return onMounted(() => i9.value = true), onUnmounted(() => i9.value = false), onMounted(() => {
    watch([n6, r4, l4], (e3, m4) => {
      if (e3.every((a5, s7) => (m4 == null ? void 0 : m4[s7]) === a5) || !l4.value)
        return;
      let f5 = o3(n6);
      f5 && t(() => {
        var F3, H5;
...
function E4(d9, f5 = ref(true)) {
  watchEffect((o7) => {
    ...
    o7(function() {
      ...
      if (r4 === 1 ? t7.delete(e3) : t7.set(e3, r4 - 1), r4 !== 1)
        return;
      let n6 = i8.get(e3);
...
function N4({ defaultContainers: o7 = [], portals: i9, mainTreeNodeRef: H5 } = {}) {
  ...
  function u9() {
    ...
    let n6 = [];
    for (let e3 of o7)
      e3 !== null && (e3 instanceof HTMLElement ? n6.push(e3) : "value" in e3 && e3.value instanceof HTMLElement && n6.push(e3.value));
    if (i9 != null && i9.value)
      for (let e3 of i9.value)
        n6.push(e3);
    for (let e3 of (l4 = r4 == null ? void 0 : r4.querySelectorAll("html > *, body > *")) != null ? l4 : [])
      e3 !== document.body && e3 !== document.head && e3 instanceof HTMLElement && e3.id !== "headlessui-portal-root" && (e3.contains(o3(t8)) || e3.contains((a5 = (f5 = o3(t8)) == null ? void 0 : f5.getRootNode()) == null ? void 0 : a5.host) || n6.some((M2) => e3.contains(M2)) || n6.push(e3));
    return n6;
  }
...
var u6 = defineComponent({ name: "ForcePortalRoot", props: { as: { type: [Object, String], default: "template" }, force: { type: Boolean, default: false } }, setup(o7, { slots: t8, attrs: r4 }) {
  return provide(e2, o7.force), () => {
    let _a = o7, { force: f5 } = _a, n6 = __objRest(_a, ["force"]);
...
var K2 = defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: null } }, setup(t8, { attrs: o7, slots: s7 }) {
  ...
  return onMounted(() => onUnmounted(r4.register(e3))), () => {
    let { name: i9 = "Description", slot: l4 = ref({}), props: d9 = {} } = r4, c5 = __objRest(t8, []), f5 = __spreadProps(__spreadValues({}, Object.entries(d9).reduce((a5, [g5, m4]) => Object.assign(a5, { [g5]: unref(m4) }), {})), { id: e3 });
...
var z2 = defineComponent({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(e3, { attrs: t8, slots: l4 }) {
  ...
  return provide(H2, r4), () => {
    let _a = e3, { target: i9 } = _a, o7 = __objRest(_a, ["target"]);
...
var Ye = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: A3 }, initialFocus: { type: Object, default: null }, id: { type: String, default: null }, role: { type: String, default: "dialog" } }, emits: { close: (t8) => true }, setup(t8, { emit: i9, attrs: l4, slots: p3, expose: s7 }) {
  ...
  if (s7({ el: m4, $el: m4 }), !(t8.open !== A3 || S3 !== null))
    throw new Error("You forgot to provide an `open` prop to the `Dialog`.");
  if (typeof R3.value != "boolean")
    throw new Error(`You provided an \`open\` prop to the \`Dialog\`, but the value is not a boolean. Received: ${R3.value === A3 ? void 0 : t8.open}`);
  ...
  E4(oe2, ae2), R({ type: "Dialog", enabled: computed(() => c5.value === 0), element: m4, onUpdate: (e3, a5) => {
    if (a5 === "Dialog")
      return u(e3, { [s6.Add]: () => D.value += 1, [s6.Remove]: () => D.value -= 1 });
  } });
  ...
  return d4(E6, ue4, (e3) => {
    ...
    let _a = t8, { open: e3, initialFocus: a5 } = _a, d9 = __objRest(_a, ["open", "initialFocus"]), f5 = __spreadProps(__spreadValues({}, l4), { ref: m4, id: n6, role: g5.value, "aria-modal": c5.value === 0 ? true : void 0, "aria-labelledby": M2.value, "aria-describedby": re2.value }), L3 = { open: c5.value === 0 };
    return h(u6, { force: true }, () => [h($2, () => h(z2, { target: m4.value }, () => h(u6, { force: false }, () => h(ue, { initialFocus: a5, containers: B2, features: k3.value ? u(ee2.value, { parent: ue.features.RestoreFocus, leaf: ue.features.All & ~ue.features.FocusLock }) : ue.features.None }, () => h(X, {}, () => A({ ourProps: f5, theirProps: __spreadValues(__spreadValues({}, d9), l4), slot: L3, attrs: l4, slots: p3, visible: c5.value === 0, features: N2.RenderStrategy | N2.Static, name: "Dialog" })))))), h(Z2)]);
  };
} });
...
var ze = defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: null } }, inheritAttrs: false, setup(t8, { attrs: i9, slots: l4, expose: p3 }) {
  ...
  return p3({ el: u9, $el: u9 }), onMounted(() => {
    if (n6.panelRef.value === null)
      throw new Error("A <DialogBackdrop /> component is being used, but a <DialogPanel /> component is missing.");
  }), () => {
    let g5 = __objRest(t8, []), D = { id: s7, ref: u9, "aria-hidden": true };
    return h(u6, { force: true }, () => h($2, () => A({ ourProps: D, theirProps: __spreadValues(__spreadValues({}, i9), g5), slot: { open: n6.dialogState.value === 0 }, attrs: i9, slots: l4, name: "DialogBackdrop" })));
  };
} });
var Ge = defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: null } }, setup(t8, { attrs: i9, slots: l4, expose: p3 }) {
  ...
  return () => {
    let g5 = __objRest(t8, []), D = { id: s7, ref: n6.panelRef, onClick: u9 };
...
var N5 = defineComponent({ name: "Disclosure", props: { as: { type: [Object, String], default: "template" }, defaultOpen: { type: [Boolean], default: false } }, setup(t8, { slots: r4, attrs: o7 }) {
  ...
  return provide(T4, n6), t4(computed(() => u(s7.value, { [0]: i7.Open, [1]: i7.Closed }))), () => {
    let _a = t8, { defaultOpen: l4 } = _a, a5 = __objRest(_a, ["defaultOpen"]), c5 = { open: s7.value === 0, close: n6.close };
...
var Q = defineComponent({ name: "DisclosureButton", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: null } }, setup(t8, { attrs: r4, slots: o7, expose: s7 }) {
  ...
  return () => {
    var C3;
    let u9 = { open: e3.disclosureState.value === 0 }, _a = t8, { id: S3 } = _a, K4 = __objRest(_a, ["id"]), M2 = n6.value ? { ref: l4, type: a5.value, onClick: c5, onKeydown: D } : { id: (C3 = e3.buttonId.value) != null ? C3 : S3, ref: l4, type: a5.value, "aria-expanded": e3.disclosureState.value === 0, "aria-controls": e3.disclosureState.value === 0 || o3(e3.panel) ? e3.panelId.value : void 0, disabled: t8.disabled ? true : void 0, onClick: c5, onKeydown: D, onKeyup: v4 };
...
var V = defineComponent({ name: "DisclosurePanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: null } }, setup(t8, { attrs: r4, slots: o7, expose: s7 }) {
  ...
  return () => {
    var v4;
    let l4 = { open: e3.disclosureState.value === 0, close: e3.close }, _a = t8, { id: a5 } = _a, c5 = __objRest(_a, ["id"]), D = { id: (v4 = e3.panelId.value) != null ? v4 : a5, ref: e3.panel };
...
function o6(e3) {
  ...
  if (!(t8 instanceof HTMLElement))
    return n6;
  let u9 = false;
  for (let f5 of t8.querySelectorAll('[hidden],[aria-hidden],[role="img"]'))
    f5.remove(), u9 = true;
...
var Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o7) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o7, { slots: b2, attrs: r4, emit: w6 }) {
  ...
  return onMounted(() => {
    watch([C3], () => {
      if (!C3.value || o7.defaultValue === void 0)
        return;
      function t8() {
    ...
    let _a = o7, { name: t8, modelValue: i9, disabled: l4, form: d9 } = _a, O4 = __objRest(_a, ["name", "modelValue", "disabled", "form"]), h3 = { open: n6.value === 0, disabled: l4, value: M2.value };
    return h(Fragment, [...t8 != null && M2.value != null ? e({ [t8]: M2.value }).map(([I2, Q3]) => h(f, E2({ features: u4.Hidden, key: I2, as: "input", type: "hidden", hidden: true, readOnly: true, form: d9, disabled: l4, name: I2, value: Q3 }))) : [], A({ ourProps: {}, theirProps: __spreadValues(__spreadValues({}, r4), T2(O4, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"])), slot: h3, slots: b2, attrs: r4, name: "Listbox" })]);
  };
} });
var Ee2 = defineComponent({ name: "ListboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(o7, { attrs: b2, slots: r4 }) {
  ...
  return () => {
    let v4 = { open: n6.listboxState.value === 0, disabled: n6.disabled.value }, s7 = __objRest(o7, []), m4 = { id: w6, ref: n6.labelRef, onClick: e3 };
...
var je = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o7, { attrs: b2, slots: r4, expose: w6 }) {
  ...
  return () => {
    var y4, L3;
    let a5 = { open: e3.listboxState.value === 0, disabled: e3.disabled.value, value: e3.value.value }, u9 = __objRest(o7, []), D = { ref: e3.buttonRef, id: n6, type: m4.value, "aria-haspopup": "listbox", "aria-controls": (y4 = o3(e3.optionsRef)) == null ? void 0 : y4.id, "aria-expanded": e3.listboxState.value === 0, "aria-labelledby": e3.labelRef.value ? [(L3 = o3(e3.labelRef)) == null ? void 0 : L3.id, n6].join(" ") : void 0, disabled: e3.disabled.value === true ? true : void 0, onKeydown: f5, onKeyup: v4, onClick: s7 };
...
var Fe = defineComponent({ name: "ListboxOption", props: { as: { type: [Object, String], default: "li" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false }, id: { type: String, default: null } }, setup(o7, { slots: b2, attrs: r4, expose: w6 }) {
  ...
  return () => {
    let { disabled: t8 } = o7, i9 = { active: v4.value, selected: s7.value, disabled: t8 }, _a = o7, { value: l4, disabled: d9 } = _a, O4 = __objRest(_a, ["value", "disabled"]), h3 = { id: n6, ref: f5, role: "option", tabIndex: t8 === true ? void 0 : -1, "aria-disabled": t8 === true ? true : void 0, "aria-selected": s7.value, disabled: void 0, onClick: u9, onFocus: D, onPointerenter: L3, onMouseenter: L3, onPointermove: M2, onMousemove: M2, onPointerleave: k3, onMouseleave: k3 };
...
var Se = defineComponent({ name: "MenuButton", props: { disabled: { type: Boolean, default: false }, as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o7, { attrs: M2, slots: i9, expose: I2 }) {
  ...
  return () => {
    var n6;
    let l4 = { open: e3.menuState.value === 0 }, t8 = __objRest(o7, []), a5 = { ref: e3.buttonRef, id: p3, type: g5.value, "aria-haspopup": "menu", "aria-controls": (n6 = o3(e3.itemsRef)) == null ? void 0 : n6.id, "aria-expanded": e3.menuState.value === 0, onKeydown: r4, onKeyup: f5, onClick: d9 };
...
var Me = defineComponent({ name: "MenuItems", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: null } }, setup(o7, { attrs: M2, slots: i9, expose: I2 }) {
  ...
  return () => {
    var s7, v4;
    let t8 = { open: e3.menuState.value === 0 }, a5 = __objRest(o7, []), n6 = { "aria-activedescendant": e3.activeItemIndex.value === null || (s7 = e3.items.value[e3.activeItemIndex.value]) == null ? void 0 : s7.id, "aria-labelledby": (v4 = o3(e3.buttonRef)) == null ? void 0 : v4.id, id: p3, onKeydown: f5, onKeyup: d9, role: "menu", tabIndex: 0, ref: e3.itemsRef };
...
var be2 = defineComponent({ name: "MenuItem", inheritAttrs: false, props: { as: { type: [Object, String], default: "template" }, disabled: { type: Boolean, default: false }, id: { type: String, default: null } }, setup(o7, { slots: M2, attrs: i9, expose: I2 }) {
  ...
  return () => {
    let _a = o7, { disabled: u9 } = _a, h3 = __objRest(_a, ["disabled"]), C3 = { active: f5.value, disabled: u9, close: e3.closeMenu };
    return A({ ourProps: { id: p3, ref: r4, role: "menuitem", tabIndex: u9 === true ? void 0 : -1, "aria-disabled": u9 === true ? true : void 0, onClick: b2, onFocus: l4, onPointerenter: a5, onMouseenter: a5, onPointermove: n6, onMousemove: n6, onPointerleave: s7, onMouseleave: s7 }, theirProps: __spreadValues(__spreadValues({}, i9), h3), slot: C3, attrs: i9, slots: M2, name: "MenuItem" });
  };
} });
...
var ye = defineComponent({ name: "Popover", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(d9, { slots: P2, attrs: s7, expose: h3 }) {
  ...
  let t8 = ref(1), o7 = ref(null), y4 = ref(null), v4 = ref(null), m4 = ref(null), b2 = computed(() => i4(f5)), E6 = computed(() => {
    ...
    for (let x2 of document.querySelectorAll("body > *"))
      if (Number(x2 == null ? void 0 : x2.contains(o3(o7))) ^ Number(x2 == null ? void 0 : x2.contains(o3(m4))))
        return true;
  ...
  return watchEffect(() => I2 == null ? void 0 : I2(S3)), E3((u9 = b2.value) == null ? void 0 : u9.defaultView, "focus", (e3) => {
    ...
    return h(Fragment, [h(w6, {}, () => A({ theirProps: __spreadValues(__spreadValues({}, d9), s7), ourProps: { ref: f5 }, slot: e3, slots: P2, attrs: s7, name: "Popover" })), h(i9.MainTreeNode)]);
  };
} });
var Ge2 = defineComponent({ name: "PopoverButton", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: null } }, inheritAttrs: false, setup(d9, { attrs: P2, slots: s7, expose: h3 }) {
    ...
    if (b2.value) {
      ...
      switch (e3.key) {
        ...
        case o4.Escape:
          ...
          if (!o3(t8.button) || (G2 = o7.value) != null && G2.activeElement && !((C3 = o3(t8.button)) != null && C3.contains(o7.value.activeElement)))
            return;
  ...
  return () => {
    let e3 = t8.popoverState.value === 0, r4 = { open: e3 }, l4 = __objRest(d9, []), g5 = b2.value ? { ref: E6, type: S3.value, onKeydown: c5, onClick: F3 } : { ref: E6, id: f5, type: S3.value, "aria-expanded": t8.popoverState.value === 0, "aria-controls": o3(t8.panel) ? t8.panelId.value : void 0, disabled: d9.disabled ? true : void 0, onKeydown: c5, onKeyup: I2, onClick: F3, onMousedown: w6 };
    return h(Fragment, [A({ ourProps: g5, theirProps: __spreadValues(__spreadValues({}, P2), l4), slot: r4, attrs: P2, slots: s7, name: "PopoverButton" }), e3 && !b2.value && t8.isPortalled.value && h(f, { id: a5, features: u4.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: p3 })]);
  };
} });
...
var je2 = defineComponent({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, focus: { type: Boolean, default: false }, id: { type: String, default: null } }, inheritAttrs: false, setup(d9, { attrs: P2, slots: s7, expose: h3 }) {
  ...
  h3({ el: o7.panel, $el: o7.panel }), onMounted(() => {
    ...
    var p3, u9;
    if (!t8 || o7.popoverState.value !== 0 || !o7.panel)
      return;
  ...
  function a5(i9) {
    ...
    switch (i9.key) {
      case o4.Escape:
        if (o7.popoverState.value !== 0 || !o3(o7.panel) || y4.value && !((p3 = o3(o7.panel)) != null && p3.contains(y4.value.activeElement)))
          return;
  ...
  return () => {
    let i9 = { open: o7.popoverState.value === 0, close: o7.close }, _a = d9, { focus: p3 } = _a, u9 = __objRest(_a, ["focus"]), e3 = { ref: o7.panel, id: f5, onKeydown: a5, onFocusout: t8 && o7.popoverState.value === 0 ? S3 : void 0, tabIndex: -1 };
    return A({ ourProps: e3, theirProps: __spreadValues(__spreadValues({}, P2), u9), attrs: P2, slot: i9, slots: __spreadProps(__spreadValues({}, s7), { default: (...r4) => {
      var l4;
...
var Ae3 = defineComponent({ name: "PopoverGroup", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(d9, { attrs: P2, slots: s7, expose: h3 }) {
  ...
  return provide(le, { registerPopover: m4, unregisterPopover: v4, isFocusWithinPopoverGroup: b2, closeOthers: E6, mainTreeNodeRef: y4.mainTreeNodeRef }), () => h(Fragment, [A({ ourProps: { ref: f5 }, theirProps: __spreadValues(__spreadValues({}, d9), P2), slot: {}, attrs: P2, slots: s7, name: "PopoverGroup" }), h(y4.MainTreeNode)]);
} });
...
var K3 = defineComponent({ name: "Label", props: { as: { type: [Object, String], default: "label" }, passive: { type: [Boolean], default: false }, id: { type: String, default: null } }, setup(t8, { slots: n6, attrs: i9 }) {
  ...
  return onMounted(() => onUnmounted(o7.register(e3))), () => {
    let { name: l4 = "Label", slot: p3 = {}, props: c5 = {} } = o7, _a = t8, { passive: f5 } = _a, s7 = __objRest(_a, ["passive"]), u9 = __spreadProps(__spreadValues({}, Object.entries(c5).reduce((b2, [g5, m4]) => Object.assign(b2, { [g5]: unref(m4) }), {})), { id: e3 });
...
var he = defineComponent({ name: "RadioGroup", emits: { "update:modelValue": (t8) => true }, props: { as: { type: [Object, String], default: "div" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => le2 }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, id: { type: String, default: null } }, inheritAttrs: false, setup(t8, { emit: m4, attrs: u9, slots: S3, expose: g5 }) {
  ...
  let [f5, G2] = d(computed(() => t8.modelValue), (e3) => m4("update:modelValue", e3), computed(() => t8.defaultValue)), s7 = { options: l4, value: f5, disabled: computed(() => t8.disabled), firstOption: computed(() => l4.value.find((e3) => !e3.propsRef.disabled)), containsCheckedOption: computed(() => l4.value.some((e3) => s7.compare(toRaw(e3.propsRef.value), toRaw(t8.modelValue)))), compare(e3, a5) {
    ...
    var n6;
    if (t8.disabled || s7.compare(toRaw(f5.value), toRaw(e3)))
      return false;
  ...
  return onMounted(() => {
    ...
    let _a = t8, { disabled: e3, name: a5, form: n6 } = _a, i9 = __objRest(_a, ["disabled", "name", "form"]), r4 = { ref: p3, id: d9, role: "radiogroup", "aria-labelledby": R3.value, "aria-describedby": T5.value, onKeydown: v4 };
    return h(Fragment, [...a5 != null && f5.value != null ? e({ [a5]: f5.value }).map(([c5, L3]) => h(f, E2({ features: u4.Hidden, key: c5, as: "input", type: "hidden", hidden: true, readOnly: true, form: n6, disabled: e3, name: c5, value: L3 }))) : [], A({ ourProps: r4, theirProps: __spreadValues(__spreadValues({}, u9), T2(i9, ["modelValue", "defaultValue", "by"])), slot: {}, attrs: u9, slots: S3, name: "RadioGroup" })]);
  };
} });
...
var Oe = defineComponent({ name: "RadioGroupOption", props: { as: { type: [Object, String], default: "div" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false }, id: { type: String, default: null } }, setup(t8, { attrs: m4, slots: u9, expose: S3 }) {
  ...
  return () => {
    let _a = t8, { value: r4, disabled: c5 } = _a, L3 = __objRest(_a, ["value", "disabled"]), K4 = { checked: b2.value, disabled: v4.value, active: Boolean(f5.value & 2) }, M2 = { id: g5, ref: R3, role: "radio", "aria-checked": b2.value ? "true" : "false", "aria-labelledby": p3.value, "aria-describedby": l4.value, "aria-disabled": v4.value ? true : void 0, tabIndex: O4.value, onClick: v4.value ? void 0 : e3, onFocus: v4.value ? void 0 : a5, onBlur: v4.value ? void 0 : n6 };
...
var ue3 = defineComponent({ name: "Switch", emits: { "update:modelValue": (l4) => true }, props: { as: { type: [Object, String], default: "button" }, modelValue: { type: Boolean, default: void 0 }, defaultChecked: { type: Boolean, optional: true }, form: { type: String, optional: true }, name: { type: String, optional: true }, value: { type: String, optional: true }, id: { type: String, default: null }, disabled: { type: Boolean, default: false }, tabIndex: { type: Number, default: 0 } }, inheritAttrs: false, setup(l4, { emit: c5, attrs: i9, slots: r4, expose: f5 }) {
  ...
  return onMounted(() => {
    watch([d9], () => {
      if (!d9.value || l4.defaultChecked === void 0)
        return;
      function e3() {
    ...
    let _a = l4, { name: e3, value: a5, form: K4, tabIndex: y4 } = _a, b2 = __objRest(_a, ["name", "value", "form", "tabIndex"]), T5 = { checked: t8.value }, B2 = { id: p3, ref: o7, role: "switch", type: L3.value, tabIndex: y4 === -1 ? 0 : y4, "aria-checked": t8.value, "aria-labelledby": n6 == null ? void 0 : n6.labelledby.value, "aria-describedby": n6 == null ? void 0 : n6.describedby.value, onClick: D, onKeyup: R3, onKeypress: x2 };
    return h(Fragment, [e3 != null && t8.value != null ? h(f, E2({ features: u4.Hidden, as: "input", type: "checkbox", hidden: true, readOnly: true, checked: t8.value, form: K4, disabled: b2.disabled, name: e3, value: a5 })) : null, A({ ourProps: B2, theirProps: __spreadValues(__spreadValues({}, i9), T2(b2, ["modelValue", "defaultChecked"])), slot: T5, attrs: i9, slots: r4, name: "Switch" })]);
  };
} });
var de = K3;
var ce2 = K2;
  ...
  return onMounted(() => {
    ...
    return h(Fragment, [l4.value.length <= 0 && h(d7, { onFocus: () => {
      for (let n6 of l4.value) {
        let o7 = o3(n6);
        if ((o7 == null ? void 0 : o7.tabIndex) === 0)
          return o7.focus(), true;
      }
      return false;
    } }), A({ theirProps: __spreadValues(__spreadValues({}, s7), T2(a5, ["selectedIndex", "defaultIndex", "manual", "vertical", "onChange"])), ourProps: {}, slot: t8, slots: b2, attrs: s7, name: "TabGroup" })]);
  };
} });
...
var xe = defineComponent({ name: "Tab", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: null } }, setup(a5, { attrs: b2, slots: s7, expose: d9 }) {
  ...
  return () => {
    var m4, h3;
    let e3 = { selected: u9.value, disabled: (m4 = a5.disabled) != null ? m4 : false }, c5 = __objRest(a5, []), I2 = { ref: r4, onKeydown: x2, onMousedown: t8, onClick: E6, id: i9, role: "tab", type: n6.value, "aria-controls": (h3 = o3(l4.panels.value[y4.value])) == null ? void 0 : h3.id, "aria-selected": u9.value, tabIndex: u9.value ? 0 : -1, disabled: a5.disabled ? true : void 0 };
...
var ye2 = defineComponent({ name: "TabPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: null }, tabIndex: { type: Number, default: 0 } }, setup(a5, { attrs: b2, slots: s7, expose: d9 }) {
  ...
  return () => {
    var n6;
    let x2 = { selected: u9.value }, _a = a5, { tabIndex: w6 } = _a, E6 = __objRest(_a, ["tabIndex"]), t8 = { ref: r4, id: i9, role: "tabpanel", "aria-labelledby": (n6 = o3(l4.tabs.value[y4.value])) == null ? void 0 : n6.id, tabIndex: u9.value ? w6 : -1 };
    return !u9.value && a5.unmount && !a5.static ? h(f, __spreadValues({ as: "span", "aria-hidden": true }, t8)) : A({ ourProps: t8, theirProps: E6, slot: x2, attrs: b2, slots: s7, features: N2.Static | N2.RenderStrategy, visible: u9.value, name: "TabPanel" });
  };
} });
...
var he2 = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e3, { emit: t8, attrs: a5, slots: s7, expose: h3 }) {
  ...
  if (!me3() && s4())
    return () => h(Se3, __spreadProps(__spreadValues({}, e3), { onBeforeEnter: r4, onAfterEnter: l4, onBeforeLeave: f5, onAfterLeave: S3 }), s7);
  ...
  onMounted(() => {
    watchEffect(() => {
      if (i9.value === "visible") {
        let o7 = o3(d9);
        if (o7 instanceof Comment && o7.data === "")
  ...
  return onMounted(() => {
    ...
    let _a = e3, { appear: o7, show: E6, enter: p3, enterFrom: V2, enterTo: Ce, entered: ye3, leave: be3, leaveFrom: Ee4, leaveTo: Ve3 } = _a, U5 = __objRest(_a, ["appear", "show", "enter", "enterFrom", "enterTo", "entered", "leave", "leaveFrom", "leaveTo"]), ne2 = { ref: d9 }, re2 = __spreadValues(__spreadValues({}, U5), A6.value && v4.value && c.isServer ? { class: normalizeClass([a5.class, U5.class, ...j2, ...M2]) } : {});
...
var Se3 = defineComponent({ inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e3, { emit: t8, attrs: a5, slots: s7 }) {
  ...
  return onMounted(() => {
    ...
    return A({ ourProps: __spreadProps(__spreadValues({}, y4), { as: "template" }), theirProps: {}, slot: {}, slots: __spreadProps(__spreadValues({}, s7), { default: () => [h(ce3, __spreadValues(__spreadValues(__spreadValues({ onBeforeEnter: () => t8("beforeEnter"), onAfterEnter: () => t8("afterEnter"), onBeforeLeave: () => t8("beforeLeave"), onAfterLeave: () => t8("afterLeave") }, a5), y4), d9), s7.default)] }), attrs: {}, features: W2, visible: r4.value === "visible", name: "Transition" });
  };
} });
export {
  lt as Combobox,
