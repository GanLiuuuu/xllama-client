...
function inner_stringify(object, prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, encoder, filter, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, sideChannel) {
  ...
  if (is_non_nullish_primitive(obj) || is_buffer(obj)) {
    if (encoder) {
      ...
      return [
        (formatter == null ? void 0 : formatter(key_value)) + "=" + (formatter == null ? void 0 : formatter(encoder(obj, defaults.encoder, charset, "value", format)))
      ];
    }
...
var Completions = class extends APIResource {
  create(body, options) {
    var _a2;
    return this._client.post("/chat/completions", __spreadProps(__spreadValues({ body }, options), { stream: (_a2 = body.stream) != null ? _a2 : false }));
  }
};
    ...
    return __spreadProps(__spreadValues({}, completion), {
      choices: completion.choices.map((choice) => {
        ...
        return __spreadProps(__spreadValues({}, choice), {
          message: __spreadProps(__spreadValues({}, choice.message), { parsed: null, tool_calls: (_a2 = choice.message.tool_calls) != null ? _a2 : [] })
        });
      })
    });
  }
...
_AbstractChatCompletionRunner_instances = /* @__PURE__ */ new WeakSet(), _AbstractChatCompletionRunner_getFinalContent = function _AbstractChatCompletionRunner_getFinalContent2() {
  ...
  while (i-- > 0) {
    ...
    if (isAssistantMessage(message)) {
      const _a2 = message, { function_call } = _a2, rest = __objRest(_a2, ["function_call"]);
    ...
    for (const _l of chunk.choices) {
      ...
      if (logprobs) {
        if (!choice.logprobs) {
          ...
          if (content2) {
            (_c2 = (_a2 = choice.logprobs).content) != null ? _c2 : _a2.content = [];
...
var Runs = class extends APIResource {
  ...
  create(threadId, params, options) {
    var _b;
    const _a2 = params, { include } = _a2, body = __objRest(_a2, ["include"]);
...
var FileBatches = class extends APIResource {
  ...
  listFiles(vectorStoreId, batchId, query = {}, options) {
    ...
    return this._client.getAPIList(`/vector_stores/${vectorStoreId}/file_batches/${batchId}/files`, VectorStoreFilesPage, __spreadProps(__spreadValues({ query }, options), { headers: __spreadValues({ "OpenAI-Beta": "assistants=v2" }, options == null ? void 0 : options.headers) }));
  }
...
var Completions3 = class extends APIResource {
  create(body, options) {
    var _a2;
    return this._client.post("/completions", __spreadProps(__spreadValues({ body }, options), { stream: (_a2 = body.stream) != null ? _a2 : false }));
  }
};
...
var Files2 = class extends APIResource {
  ...
  retrieveContent(fileId, options) {
    return this._client.get(`/files/${fileId}/content`, __spreadProps(__spreadValues({}, options), {
      headers: __spreadValues({ Accept: "application/json" }, options == null ? void 0 : options.headers)
    }));
  }
...
var Parts = class extends APIResource {
  create(uploadId, body, options) {
    return this._client.post(`/uploads/${uploadId}/parts`, multipartFormRequestOptions(__spreadValues({ body }, options)));
  }
};
...
var OpenAI = class extends APIClient {
  constructor(_c = {}) {
    var _d = _c, { baseURL = readEnv("OPENAI_BASE_URL"), apiKey = readEnv("OPENAI_API_KEY"), organization = ((_a2) => (_a2 = readEnv("OPENAI_ORG_ID")) != null ? _a2 : null)(), project = ((_b) => (_b = readEnv("OPENAI_PROJECT_ID")) != null ? _b : null)() } = _d, opts = __objRest(_d, ["baseURL", "apiKey", "organization", "project"]);
    var _a3;
    if (apiKey === void 0) {
...
var AzureOpenAI = class extends OpenAI {
  constructor(_a2 = {}) {
    var _b = _a2, { baseURL = readEnv("OPENAI_BASE_URL"), apiKey = readEnv("AZURE_OPENAI_API_KEY"), apiVersion = readEnv("OPENAI_API_VERSION"), endpoint, deployment, azureADTokenProvider, dangerouslyAllowBrowser } = _b, opts = __objRest(_b, ["baseURL", "apiKey", "apiVersion", "endpoint", "deployment", "azureADTokenProvider", "dangerouslyAllowBrowser"]);
    if (!apiVersion) {
...
// dep:openai
var openai_default2 = openai_default;
export {
  APIConnectionError,
