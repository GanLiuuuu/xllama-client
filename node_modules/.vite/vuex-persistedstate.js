...
function t(r2, e2) {
  return e2.clone !== false && e2.isMergeableObject(r2) ? u(Array.isArray(r2) ? [] : {}, r2, e2) : r2;
}
function n(r2, e2, n2) {
  ...
  return f === Array.isArray(e2) ? f ? a2.arrayMerge(e2, i2, a2) : function(r2, e3, n2) {
    ...
    return n2.isMergeableObject(r2) && o(r2).forEach(function(e4) {
      ...
      (function(r3, e4) {
        ...
        return typeof t2 == "function" ? t2 : u;
...
function a(r2) {
  ...
  function n2(r3, e3) {
    ...
    try {
      return typeof t3 == "string" ? JSON.parse(t3) : typeof t3 == "object" ? t3 : void 0;
    } catch (r4) {
    }
  }
  function o2() {
  ...
  function u2(r3, e3) {
    return Array.isArray(e3) ? e3.reduce(function(e4, t3) {
      ...
      }(e4, t3, (n3 = r3, (n3 = ((o3 = t3).split ? o3.split(".") : o3).reduce(function(r4, e5) {
        return r4 && r4[e5];
      }, n3)) === void 0 ? void 0 : n3));
      var n3, o3;
    }, {}) : r3;
  ...
  return r2.fetchBeforeUse && (f = s()), function(n3) {
    r2.fetchBeforeUse || (f = s()), typeof f == "object" && f !== null && (n3.replaceState(r2.overwrite ? f : i(n3.state, f, { arrayMerge: r2.arrayMerger || function(r3, e3) {
      return e3;
